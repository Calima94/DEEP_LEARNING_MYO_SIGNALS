...
class EmgApplication(Ui_Form):
    ...
    def apply_modern_styling(self):
        ...
        # Apply styles
        self.setStyleSheet(main_style + button_style + frame_style + label_style + input_style + tab_style + tree_style)
    ...
    def plot_values_of_channels_process_emg(self, df, col1, col2) -> None:
        ...
        if self.data_and_classifiers is not None:
            ...
            for i, j in enumerate(categories):
                mask = df["Category"] == j
                df_x = df[mask]
                ax1.scatter(x=df_x[df.columns[col1 - 1]], y=df_x[df.columns[col2 - 1]], 
